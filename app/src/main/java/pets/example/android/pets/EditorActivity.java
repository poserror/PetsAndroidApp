package pets.example.android.pets;
...
import pets.example.android.pets.data.PetContract.PetEntry;
import pets.example.android.pets.data.PetDbHelper;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                Log.v("MESSAGE********","You Clicked Save");
                savePet();
                finish();
                return true;
